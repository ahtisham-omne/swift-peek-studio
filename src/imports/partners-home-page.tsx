Now I have the complete file. Here's the full code for PartnersHomePage.tsx — this is a self-contained page (548 lines) that only depends on react-router, react-dnd, react-dnd-html5-backend, sonner, lucide-react, and shadcn/ui's Input + Button components, plus a VendorContext for the active partner count:

// /src/app/pages/PartnersHomePage.tsx
// ─────────────────────────────────────────────
// Partners Management Home Page
// Features:
//   • Drag-and-drop reorderable module cards (react-dnd + HTML5Backend)
//   • localStorage-persisted layout with Save/Reset controls
//   • Recommended Actions section with icon cards
//   • Recent Activity feed with colored dot indicators
//   • Responsive grid: 2→3 cols for modules, 1→2 for actions, 1→3 for bottom split
//   • Top bar with search input and user avatar
//   • Primary color: #0A77FF, font: Inter
//
// Dependencies:
//   react-router (7.13.0), react-dnd, react-dnd-html5-backend,
//   sonner, lucide-react, shadcn/ui (Input, Button)
//   VendorContext (for active vendor count)
// ─────────────────────────────────────────────
...
export function PartnersHomePage() {
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Top Bar */}
      <div className="flex items-center justify-between px-3 sm:px-5 lg:px-6 h-12 border-b border-border bg-card shrink-0">
...
That's the complete PartnersHomePage.tsx — 551 lines, fully self-contained. It renders the Partners Management home screen with drag-and-drop module cards, recommended actions, and a recent activity feed.